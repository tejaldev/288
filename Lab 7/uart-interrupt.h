...
extern volatile char stop_command; // byte value for special character used as a command
extern volatile int start_flag;
extern volatile int stop_flag;// flag to tell the main program a special command was received
